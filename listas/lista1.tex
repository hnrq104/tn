...
\begin{proof}
    \textbf{(b)} Essa prova é um belo problema de contagem. Note que como $5 \equiv 1 \pmod 4$, para todo $k$, $5^k \equiv 1 \pmod 4$.
\end{proof}
