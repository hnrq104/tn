...
\begin{proof}
    ...
    portanto para cada um deles existe um único $0 \leq s < t_2$ com $71^x \equiv m \pmod{16}$. Em particular, como $-1 \equiv 7\cdot9 \pmod 16$, segue que $\frac{-1}{9} \equiv 7 \pmod{16}$
